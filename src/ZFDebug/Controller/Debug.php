...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
     ...
     * @var array
     */
    public static $standardPlugins = array('Cache', 'Html', 'Database', 'Exception', 'File', 'Memory', 'Log', 'Registry', 'Session', 'Phpinfo','Time', 'Variables', 'Controller', 'Perfomance',  'Users');
    ...
    protected function _headerOutput() {
        ...
        return ('
            <style type="text/css" media="screen">
                ...
                .ZFDebug_panel { text-align:left; position:absolute;bottom:21px;width:975px; max-height:400px; overflow:auto; display:none; background:#E8E8E8; padding:5px; border: 1px solid #999; }
